...
export const metadata: Metadata = {
  ...
  description:
    "JUDAION Studios is a brand strategy and identity studio for visionary founders. High-torque, monochrome-led visuals where strategy meets cinematic rigour.",
