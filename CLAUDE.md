...
- **Asset Pipelines:** `POST /api/upload` returns an OCI presigned PUT URL (`getSignedUrl`, `expiresIn: 60`, `OCI_BUCKET_NAME`); the browser PUTs the file directly, circumventing Vercel’s 4.5 MB body limit[cite: 1, 2].
