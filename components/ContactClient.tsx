        ...
        >
          ...
          <div
            className={`absolute z-10 ${
              isMobile
                ? "contact-form-mobile-pinned"
                : "w-[26%] h-[39%] top-[28%] left-[52%]"
            } pointer-events-auto flex flex-col justify-center`}
          >
            ...
            >
              ...
              <div className="col-span-2 border border-white/60 bg-white/[0.02] p-3">
                <span className="text-white font-brand-secondary-thin text-[10px] tracking-widest uppercase mb-2 block">
                  AUTHORITY Selection:
                </span>
