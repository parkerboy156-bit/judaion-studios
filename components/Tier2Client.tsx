    ...
    <main className="relative bg-black">
      ...
      <div className="flex w-full h-screen bg-[#0a0a0a] overflow-hidden font-mono selection:bg-orange-600">
        ...
        >
          ...
          <div className="relative w-full pt-12 pb-6 z-20 overflow-hidden"></div>
          ...
          <div className="flex-1 px-16 flex flex-col justify-center items-end text-right">
            <div className="mb-auto mt-top">
              <h2 className="text-[58px] tracking-[0.2em] uppercase text-white font-brand-compressed">
                What it includes:
              </h2>
                    ...
                    <span
                      ...
                      dangerouslySetInnerHTML={{
                        __html: spec
                          .replace(
                            /<span>/g,
                            '<span class="font-brand-med-italic-cn text-white">',
                          )
                          .replace(/<\/span>/g, "</span>"),
                      }}
                    />
                    {/* THE DOT BULLET */}
                    <span className="text-white ml-3 text-[10px] leading-none">
                      •
                    </span>
                  </motion.div>
                ))}
